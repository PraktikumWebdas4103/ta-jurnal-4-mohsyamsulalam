<center><body style="font-family: kristen itc regular; background-color: #2b7cff;">
...
<form action="prosesTA.php" method="POST">
	...
	<table>
		<tr>
			<td>Username : <input type="text" name="user" style="width: 60%; height: 4%; color: black; background-color: white; border-radius: 5px"><br><br></td>
		</tr>
		<tr>
	 		<td>Password : <input type="Password" name="pass" style="width: 60%; height: 4%; color: black; background-color: white; border-radius: 5px"><br><br></td>
	 	</tr>
	 </table>
	<?php
			if(isset($data)){ ?>
